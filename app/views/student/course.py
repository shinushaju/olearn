...
def course(course_id, lecture_id):
    ...
    return render_template('course/course-page.html', course=course,result=result, lecture=lecture, review_list=review_list, enrolled=enrolled, can_write_review=can_write_review)
